...
<body class="hold-transition skin-blue sidebar-mini">
												...
												<td>
													<div class="btn-group">
														<a href="#" class="btn btn-info" data-toggle="modal"
															...
															onclick="editProblem('${user.SOLUTION_ID}','${user.SERVICE_TYPE_ID}','${user.PROBLEM_ID}')">
												...
												<td>
													<div>
														<a href="" class="btn btn-default" data-toggle="modal"
															...
															onclick="return deleteProblem('${user.SOLUTION_ID}')">
	...
	<jsp:include page="${request.contextPath}/dialogsolution"></jsp:include>
	...
	<script src="<c:url value="/resources/function/solution.js?a=132" />"></script>
