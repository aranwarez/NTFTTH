    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">New Solution for problems Define</h4>
            </div>
               ...
               <div class="modal-body">
                ...
                <div class="form-group">
                        <label for="name">DESCRIPTION</label> <input type="text"
                                                                     class="form-control" name="DESCRIPTION" id="DESCRIPTION" placeholder="Enter Solution description">
                    </div>
                    
                     <div class="form-group">
                        <label for="jsonlist">SERVICE</label> 
                        <select  name="SERVICE_TYPE_ID" id="SERVICE_TYPE_ID" onchange="loadproblem(this.value)" class="form-control chosen-select" style="width:350px;">
                    ...
                    <div class="form-group">
                        <label for="jsonlist">Problem</label> 
                        <select   id="PROBLEM_CODE"   class="form-control chosen-select" style="width:350px;">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Edit Solution for Problem</h4>
            </div>
            ...
            <form action="#" method="post"
                 ...
                 <div class="form-group">
                        <label for="name">DESCRIPTION</label> <input type="text"
                                                                     class="form-control" name="EDITDESCRIPTION" id="EDITDESCRIPTION" placeholder="Enter Solution description">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="jsonlist">Problem</label> 
                        <select   id="ePROBLEM_CODE"   class="form-control chosen-select" style="width:350px;">
