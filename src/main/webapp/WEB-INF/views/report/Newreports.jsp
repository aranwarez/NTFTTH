...
<link rel="icon"
	href="<c:url value="/resources/adminltd/images/favicon.ico" />"
	type="image/x-icon">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">FTTH Complain Summary / Detail Report</li>
				</ol>
							...
							<div class="box-body">
								<form method="post">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<select id="pm_servicetype" name="pm_servicetype"
												class="form-control">
										...
										<div class="col-md-2">
											<select id="reportname" name="reportname"
												onchange="onreportchange();" class="form-control">
												<option value="UserReport">User Report</option>
												<option value="UseridOfficeMap">UserID</option>
...
<!-- 												new report -->
									...
									<div class="row">
										<div class="col-md-2">
										<label>Solved/Closed Within</label>
											<input type="number" value="30" class="form-control"
												name="pm_within_days" id="pm_within_days"
												placeholder="Solved/Closed Within Days">
										</div>
									</div>
								</form>
							</div>
	...
	<script
		src="<c:url value="/resources/function/Report/newreport.js?verdt=527" />"></script>
