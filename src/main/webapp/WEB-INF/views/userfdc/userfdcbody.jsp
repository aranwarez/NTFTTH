...
<div class="col-xs-12 table-responsive">
				<select id="USER_ID" class="form-control" style="overflow:auto;width: 260px;important!" onchange="return getEditMode()">					
...
<input type="submit" name="save" value="save"
	onclick="return saveUserFDC()" class="btn btn-success">
