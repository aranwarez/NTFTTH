...
<!--                                        from here -->
    	...
    	<c:when test="${USER_LEVEL=='1'}">
      					...
      					<select id="REGION_CODE" name="REGION_CODE" onchange="return getZone()" class="form-control">
...
<c:otherwise>
    <select id="REGION_CODE" name="REGION_CODE" class="form-control"  onchange="return getZone()">
   	 ...
   	 <c:if test="${USER_LEVEL=='2'}"> <option value="">Select Region</option> </c:if>     
 				...
 				<c:when test="${USER_LEVEL=='3'}">
      					...
      					<select id="ZONE_CODE" name="ZONE_CODE"  class="form-control" onchange = "getDistrict()" >
   		 ...
   		 <c:otherwise>
   	 		<select id="ZONE_CODE" name="ZONE_CODE" onchange="return getDistrict()" class="form-control">
    			...
    			<c:when test="${USER_LEVEL=='4'}">
  					  ...
  					  <select id="DISTRICT_CODE" name="DISTRICT_CODE" onchange="return getOffice()" class="form-control">
...
<!--                                        to here -->
                                       <input type="hidden" name="reportname" value="ComplainHandlingsummary">
