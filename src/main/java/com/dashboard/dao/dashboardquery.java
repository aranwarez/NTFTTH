...
public class dashboardquery {
	public List<Map<String, Object>> getSRVwiseRevenue(String username) throws SQLException {
	...
	public List<Map<String, Object>> getSRVwisepayable(String user) throws SQLException {
		Connection con = DbCon.getConnection();
	...
	public List<Map<String, Object>> getSolvedvsUnsovled(String user) throws SQLException {
		Connection con = DbCon.getConnection();
