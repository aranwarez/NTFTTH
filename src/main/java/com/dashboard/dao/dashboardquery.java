...
public class dashboardquery {
	...
	public List<Map<String, Object>> subTeamSolveUnsolve(String user,String SUB_TEAM_CODE,String SERVICE_TYPE_ID,String FROM_DT,String TO_DT) throws SQLException {
		Connection con = DbCon.getConnection();
