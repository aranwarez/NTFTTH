...
public class DepartmentController {
    ...
    @ResponseBody
    public String saveJSService(String DEPARTMENT_CODE, String ContactNo, HttpServletRequest request,HttpSession session, Model model, Locale locale) throws SQLException {
    ...
    //  ADD_FLAG
        ...
        String msg = null;
        try {
            msg = dao.saveDepartment(DEPARTMENT_CODE, ContactNo, USER);
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    @ResponseBody
    public String updateService(String ID,String Department,String ContactNo,  HttpServletRequest request, HttpSession session, Model model, Locale locale) throws SQLException {
    ...
    //  EDIT_FLAG
        ...
        String msg = null;
        try {
            msg = dao.updateDepartment(Department, ContactNo, USER, ID);
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    @ResponseBody
    public String DepartmentDelete(String ID, HttpServletRequest request,Model model, Locale locale) throws SQLException {
