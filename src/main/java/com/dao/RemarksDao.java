...
public class RemarksDao {
	...
	public List<Map<String, Object>> getProblemList() throws SQLException {
        ...
        try {
            PreparedStatement pst = con.prepareStatement("SELECT ms.*, mp.DESCRIPTION PROBLEM_DESC, mst.DESCRIPTION SERVICE_DESC\r\n"
            		+ "  FROM m_remarks ms, M_PROBLEM mp, M_SERVICE_TYPE mst\r\n"
	...
	public String saveRemarks(String DESCRIPTION, String SERVICE_TYPE_ID, String ACTIVE_STATUS, String USER,String PROBLEM_ID) throws SQLException {
        Connection con = DbCon.getConnection();
        try {

            String qry = "INSERT INTO M_REMARKS (REMARKS_ID,\r\n"
            		+ "                                 PROBLEM_ID,\r\n"
            		+ "                                 DESCRIPTION,\r\n"
            		+ "                                 SERVICE_TYPE_ID,\r\n"
            		+ "                                 ACTIVE_STATUS,\r\n"
            		+ "                                 CREATE_BY)\r\n"
            		+ "     VALUES (REMARKS_SEQ_ID.NEXTVAL,\r\n"
            		+ "             ?,\r\n"
            		+ "             ?,\r\n"
            		+ "             ?,\r\n"
            		+ "             ?,\r\n"
	...
	public String updateRemarks(String PROBLEM_ID,String DESCRIPTION, String SERVICE_TYPE_ID, String SOLUTION_ID,
            String ACTIVE_STATUS, String USER) throws SQLException {
        Connection con = DbCon.getConnection();
        try {

            String qry ="UPDATE M_REMARKS\r\n"
            		+ "   SET PROBLEM_ID = ?,\r\n"
            		+ "       DESCRIPTION = ?,\r\n"
            		+ "       SERVICE_TYPE_ID = ?,\r\n"
	...
	public String DeleteProblem(String PROBLEM_ID) throws SQLException {
        Connection con = DbCon.getConnection();
        try {
            PreparedStatement pst = con.prepareStatement("delete from M_REMARKS  where REMARKS_ID=?");
            pst.setString(1, PROBLEM_ID);
